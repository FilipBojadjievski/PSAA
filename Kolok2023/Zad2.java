...
public class Zad2 {
    static SLinkedList <Integer> lista = new SLinkedList <Integer>();
    ...
    public static Integer value (){
        ...
        if (lista.getHead().next==null){
            return lista.getHead().data;
        }
        Integer prv=lista.getHead().data;
        Integer vtor=lista.getHead().next.data;
        Node <Integer> cur=lista.getHead().next.next;
        while (cur!=null) {
            Integer temp=Math.min(prv,vtor)+cur.data;
            cur=cur.next;
            prv=vtor;
            vtor=temp;
        }
        return Math.min(prv,vtor);
    }
}
